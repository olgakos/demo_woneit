...
## :watermelon: Локальный запуск тестов (из терминала)
...
## :watermelon: Jenkins (<b><a target="_blank" href="https://jenkins.autotests.cloud/job/Students/job/C02_OlgaKos_python_demo_woneit/">Job</a></b>)
<br>Удаленный запуск тестов
<br>Не требует установки программ на компьютер пользователя! Работает "как есть" онлайн.

#### Быстрый просмотр уже готового отчета:
1. <i>Не зарегистрированным</i> пользователем перейти на страницу сборки проекта по ссылке (выше) 
...
> Незарегистрированным пользователем можно открыть только уже готовый, ранее сформированный отчет
<p align="center">
...
6. Кликнуть на желтую иконку "Allure Report" и получить новый Allure Report. 
><br> NB! Срок хранения сборки на сервере ~60 дней. После ссылка может оказаться деактивирована. 
...
1. Запустить прогон тестов
2. Выполнить запрос на формирование отчета
